...
\end{array}
\end{equation}
Truncating the expansion to 1000 lags and setting ${\left( {1 - L} \right)^d}\varepsilon _t^2 = \varepsilon _t^2 + \left( {\sum\limits_{k = 1}^{1000} {{\pi _k}{L^k}} } \right)\varepsilon _t^2 = \varepsilon _t^2 + \bar \varepsilon _t^2$:
\begin{equation}
\begin{array}{l}
